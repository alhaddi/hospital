...
<page backtop="35mm" backbottom="10mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		<h4 style="text-align:center"><?=strtoupper("Daftar Setoran Internal Konsultasi")?></h4>
    </page_header>
    <page_footer>
...
?>
				<tr>
					<td style="text-align:center; border:solid 1px #000;"><?=++$no?></td>
						...
						<td style="text-align:right; border:solid 1px #000;"></td>
		...
		<tfoot>
			<tr>
				...
				<td style="text-align:right; font-style:bold; border:solid 1px #000;"></td>
