...
<page backtop="35mm" backbottom="10mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		<h4 style="text-align:center"><?=strtoupper("Daftar Setoran Registrasi")?></h4>
    </page_header>
    <page_footer>
...
?>
				<tr>
					<td style="text-align:center; border:solid 1px #000;"><?=++$no?></td>
						...
						<td style="text-align:right; border:solid 1px #000;"><?=rupiah($row['jml_pasien']*7000)?></td>
						<td style="text-align:right; border:solid 1px #000;"><?=rupiah($row['jml_pasien']*5000)?></td>
						<td style="text-align:right; border:solid 1px #000;"><?=rupiah($row['jml_pasien']*7000+$row['jml_pasien']*5000)?></td>
				</tr>
		<?php 
				$pasien+=$row['jml_pasien'];
				$rmh_sakit+=$row['jml_pasien']*7000;
				$medis+=$row['jml_pasien']*5000;
