<div style="padding: 20px">
	<div class="row">
		<div class="col-sm-3">
			...
			<select class="form-control" name="id_cara_bayar"  id="id_cara_bayar4" data-datatable-filter="true" data-datatable-id='<?=$id_table4?>'>
		...
		<div class="col-sm-3">
			...
			<div class="col-sm-6">
				<button onclick="pdf_internal()" class="btn btn-xs btn-success form-control"><span class="fa fa-print"></span> &nbsp; Pdf File </button>
			</div>
		</div>
	</div>
</div>
...
function pdf_internal(){
	...
	window.open('<?=base_url()?>report/showInternalKonsultasi?cara_bayar='+id_cara_bayar4+'&tgl1='+t1+'&tgl2='+t2+'&column_order4='+column_order4+'&dir_order4='+dir_order4);
}
