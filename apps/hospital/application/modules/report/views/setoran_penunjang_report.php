...
<page backtop="35mm" backbottom="10mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		<h4 style="text-align:center"><?=strtoupper("Daftar Setoran Penunjang")?></h4>
    </page_header>
    <page_footer>
		...
		<thead>
			<tr class="">
				<th style="text-align:center; width:20px; border:solid 1px #000;">No.</th>
						...
						<th style="text-align:center;  width:150px; border:solid 1px #000;">Penunjang</th>
...
?>
				<tr>
					<td style="text-align:center; border:solid 1px #000;"><?=++$no?></td>
						...
						<td style="text-align:left; border:solid 1px #000;"><?=$row["penunjang"]?></td>
