...
<page backtop="40mm" backbottom="4mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		...
		<thead>
			<tr	class="">
				<th style="text-align:center" style="width:20px; border:1px solid black; padding:1px;">No.</th>
						...
						<th style="text-align:center; border:1px solid black; padding:1px;">Identittas</th>
						<th style="text-align:center; border:1px solid black; padding:1px;">Nama Lengkap</th>
						<th style="text-align:center; border:1px solid black; padding:1px;">Cara Bayar</th>
						...
						<th style="text-align:center; border:1px solid black; padding:1px;">Poliklinik</th>
						<th style="text-align:center; border:1px solid black; padding:1px;">Tanggal Bergabung</th>
			</tr>
		</thead>
		<tbody>
		<?php $no = 0; foreach($query as $row) { ?>
				<tr>
					<td style="text-align:center; border:1px solid black; padding:1px;"><?=++$no?></td>
						...
						<td style="text-align:left; border:1px solid black; padding:1px;"><?=$row["tipe_identitas"].' '.$row["no_identitas"]?></td>
						...
						<td style="text-align:left; border:1px solid black; padding:1px;"><?=convert_tgl($row["tgl_bergabung"],'d M Y',1)?></td>
				</tr>
		<?php } ?>
		</tbody>
	</table>
