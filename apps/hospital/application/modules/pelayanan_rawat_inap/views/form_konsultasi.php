					...
					<div class="col-sm-7 form-vertical">
						<div class="form-group">
							<div class="text-right" >
								...
								<button style="<?=$style?>" type="button" onclick="modal_poli(<?=element('id_pasien',$konsultasi)?>)" class="btn btn-primary"><i class="fa fa-repeat"></i> Pindah Konsultasi (Poli)</button>
							</div>
						</div>
						<div class="form-group">
													...
													<thead>
														<tr class="fixheight">
															<?php if(strpos($this->session->userdata('id_pol'),'14') !== false){?>
																<th style="width:25%;" class="text-left">Keluhan Pasien</th>
																<th style="width:25%;" class="text-left">Kesimpulan</th>
																<th style="width:20%;" class="text-left">Kondisi Keluar Pasien</th>
															...
															<?php }else{ ?>
																<th style="width:40%;" class="text-left">Keluhan Pasien</th>
																<th style="width:40%;" class="text-left">Kesimpulan</th>
																<th style="width:20%;" class="text-left">Kondisi Keluar Pasien</th>
															<?php } ?>
														</tr>
													</thead>
			...
			<div class="form-vertical">
				...
				<div class="form-group">
					...
					<select name="id_jenis_appointment" class="form-control" id="id_jenis_appointment" data-rule-required="true" >
						<option value="">-- Pilih Pelayan Medik --</option>
...
var select_options = {
	ajax: {
		url: '<?=site_url('konsultasi/json_tindakan')?>',
		dataType: 'json',
		delay: 250,
		data: function (params) {
			return {
