...
class Lap_fungsional_model extends MY_Model {
	...
	function get_datatables()
	{
		...
		$this->db->select('
			...
			nama_anggaran,
			pagu,
			"11000000000" as sd_bulan_lalu1,
			"11000000000" as bulan_ini1,
			"11000000000" as sd_bulan_ini1,
			"11000000000" as sd_bulan_lalu2,
			"11000000000" as bulan_ini2,
			"11000000000" as sd_bulan_ini2,
			"11000000000" as sd_bulan_lalu3,
			"11000000000" as bulan_ini3,
			"11000000000" as sd_bulan_ini3,
			"12000000000" as jumlah_spj,
			"12000000000" as sisa_pagu
			')
		->join('anggaran','anggaran.id = pagu.id_anggaran');
		$query = $this->db->get();
		return $query->result();
	}
