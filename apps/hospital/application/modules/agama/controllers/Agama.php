...
class Agama extends MY_Controller
{
    function __construct()
    {
		...
		$this->Agama_model->initialize($config);
    }
    ...
    public function index()
    {
		$data['title'] = 'Agama';
		$data['id_table'] = 'agama';
		$data['datatable_list'] = 'agama/ajax_list';
		$data['datatable_edit'] = 'agama/ajax_edit';
		$data['datatable_delete'] = 'agama/ajax_delete';
		$data['datatable_save'] = 'agama/ajax_save';
	...
	{
		$data_object = $this->Agama_model->get_by_id($id);
		if($data_object)
		{
			$list_fields = array(
			 'id',
			...
			$fields = $this->Agama_model->list_fields($list_fields);
	...
	public function ajax_save()
	{
		...
		if(empty($post['id']))
		{
			$result = $this->Agama_model->insert($data);
		}
		else
		{
			$result = $this->Agama_model->update(array('id' => $post['id']), $data);
		}
	...
	public function excel()
	{
		...
		$query = $this->Agama_model->data_excel("agama");
	...
	public function pdf()
	{
		...
		$query = $this->Agama_model->data_pdf();
