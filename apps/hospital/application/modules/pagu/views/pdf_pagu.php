...
<page backtop="40mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <page_header>
		...
		<h1 style="text-align:center"><?=strtoupper("Daftar Menu")?></h1>
		...
		<thead>
			...
			<tr class="">
				...
				<th style="text-align:center" style="width:20px;">No.</th>
						...
						<th style="text-align:left;">Nama Anggaran</th>

						<th style="text-align:left;">Pagu</th>

						<th style="text-align:left;">Nama Periode</th>
		...
		<?php $no = 0; foreach($query as $row) { ?>
				...
				<tr>
					...
					<td style="text-align:center;"><?=++$no?></td>
						...
						<td style="text-align:left;"><?=$row["nama_anggaran"]?></td>

						<td style="text-align:left;"><?=$row["pagu"]?></td>

						<td style="text-align:left;"><?=$row["nama_periode"]?></td>
