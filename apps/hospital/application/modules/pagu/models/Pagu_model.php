...
class Pagu_model extends MY_Model {
...

	{
		...
		$query = $this->db
		->join('anggaran','anggaran.id = pagu.id_anggaran','inner')
		->join('periode_pagu','periode_pagu.id = pagu.id_periode','inner')
		->get();
...

	{
		...
		->join('periode_pagu','periode_pagu.id = pagu.id_periode')
		->get();
