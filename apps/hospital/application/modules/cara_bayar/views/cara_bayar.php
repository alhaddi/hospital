					...
					<div class="actions">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>
									<a data-download="excel" data-download-url="cara_bayar/excel"><i class="fa fa-file-excel-o fa-fw"></i> Excel (.xlsx)</a>
								</li>
								<li>
									<a data-download="pdf" data-download-url="cara_bayar/pdf"><i class="fa fa-file-pdf-o fa-fw"></i>Pdf (.pdf)</a>
								</li>
							</ul>
						</div>
					</div>
