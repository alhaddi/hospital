				...
				<div class="modal-body">
					<div class="form-vertical">
						...
						<div class="form-group">
							<label for="nama_pph" class="control-label">Nama</label>
							<input type="text" name="nama_pph" id="nama_pph" class="form-control" data-rule-required="true" data-rule-maxlength="15">
						</div>
