				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input name="rm" id="rm" readonly class="form-control" type="text">
							</div>
							<div class="col-sm-3">
								<div class="checkbox">
									<label>
										<input checked <?=(!empty($pasien['id']))?"disabled":""?> name="auto_rm" type="checkbox">Auto ?
									</label>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-6">
						...
						<div data-poli="true" class="form-group">
							<label for="textfield" class="control-label col-sm-4">Poli Tujuan</label>
							<div class="col-sm-8">
							<?php if($p == 2){?>
						...
						<div class="form-group">
							<label for="nama_orangtua" class="control-label col-sm-4">Nama Orang Tua</label>
							<div class="col-sm-8">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab_alamat" data-toggle="tab">Pembayaran & Alamat</a></li>
							<li><a href="#tab_penanggungjawab" data-toggle="tab">Penanggungjawab</a></li>
						</ul>
						<div class="tab-content padding">
							<div class="tab-pane active" id="tab_alamat">
								<div class="row"><!-- pembayaran & alamat -->
									<div class="col-sm-12">
										
										<div class="form-group">
											<label for="textfield" class="control-label col-sm-2">Asal Pasien <span class="text-danger">*</span></label>
											<div class="col-sm-4">
												<select name="asal_pasien" class="form-control" id='asal_pasien' data-rule-required="true">
							...
							<div class="tab-pane" id="tab_penanggungjawab">
								<div class="row"><!-- penanggung_jawab -->
									<div class="col-sm-6">
										<div class="form-group">
											<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<select data-pasien="true" name="penanggung_jawab[1][id]" id="penanggung_jawab1_hubungannama" >
