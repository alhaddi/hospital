...
class Pasien_model extends MY_Model {
	...
	function get_datatables()
	{
		...
		$query = $this->db->select('ms_pasien.id,rm,nama_lengkap,tipe_identitas,no_identitas,ms_cara_bayar.nama as cara_bayar,jk,usia,hp,alamat,ms_pasien.arrived_at,ms_pasien.add_time,ms_pasien.last_update')
