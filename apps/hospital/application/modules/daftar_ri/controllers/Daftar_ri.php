...
class Daftar_ri extends MY_Controller
{
    function __construct()
    {
		...
		$config['column_order'] = array(null,null,'ms_pasien.rm','ms_pasien.nama_lengkap','ms_pasien.no_identitas','ms_pasien.jk','ms_pasien.usia_thn','ms_pasien.hp','ms_pasien.alamat','ms_pasien.add_time','ms_pasien.last_update','ms_pasien.last_user',null);
		$config['column_search'] = array('ms_pasien.rm','ms_pasien.nama_lengkap','ms_pasien.tipe_identitas','ms_pasien.no_identitas','ms_pasien.hp','ms_pasien.alamat','ms_pasien.add_time','ms_pasien.last_update','ms_pasien.last_user');
		$config['column_excel'] = array('ms_pasien.rm','ms_pasien.nama_lengkap','ms_pasien.tipe_identitas','ms_pasien.no_identitas','ms_pasien.jk','ms_pasien.usia_thn','ms_pasien.hp','ms_pasien.alamat','ms_pasien.arrived_at');
		$config['column_pdf'] = array('ms_pasien.rm','ms_pasien.nama_lengkap','ms_pasien.tipe_identitas','ms_pasien.no_identitas','ms_pasien.jk','ms_pasien.usia_thn','ms_pasien.hp','ms_pasien.alamat','ms_pasien.arrived_at');
		$config['order'] = array('ms_pasien.last_update' => 'DESC');
    ...
    public function index()
    {
		...
		$data['datatable_list'] = 'daftar_ri/ajax_list/'.$p.'/'.$cr;
		$data['datatable_edit'] = 'daftar_ri/ajax_edit';
		$data['datatable_delete'] = 'daftar_ri/ajax_delete';
	...
	{	
		...
		foreach ($list as $row) {
			...
			$fields[] = $no;
			 ...
			 $fields[] = rupiah($row->tarif);
			 $fields[] = $row->nama_ruang;
			 $fields[] = $row->nama_kamar;
			 $fields[] = convert_tgl($row->tgl_daftar,'d M Y H:i',1);
