...
class Pasien_model extends MY_Model {
	...
	function get_datatables()
	{
		...
		$this->db->join("trs_rawat_inap","trs_rawat_inap.id_pasien=ms_pasien.id",'inner');
		$this->db->join("ms_kamar","trs_rawat_inap.id_kamar=ms_kamar.id",'left');
		$this->db->join("ms_ruang","trs_rawat_inap.id_ruang=ms_ruang.id",'left');
		$query = $this->db->get();
		return $query->result();
	}
