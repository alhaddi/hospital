...
<div class="container-fluid">
	<form  class='form-horizontal' id="form_<?=$id_table?>" action="<?=site_url($datatable_save)?>" method="POST" target="_blank">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="usia" id="usia" class="form-control" value="<?=$konsultasi['usia_thn']?>" readonly>
							</div>
						</div>
