...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-content box-color">
				<div class="box-title">
					<h3>
					...
					<div class="actions">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>
									<a data-download="excel" data-download-url="komponen_anamesa/excel"><i class="fa fa-file-excel-o fa-fw"></i> Excel (.xlsx)</a>
								</li>
								<li>
									<a data-download="pdf" data-download-url="komponen_anamesa/pdf"><i class="fa fa-file-pdf-o fa-fw"></i>Pdf (.pdf)</a>
								</li>
							</ul>
						</div>
					</div>
					...
					>
						<thead>
							<tr>
								...
								<th data-datatable-align="text-left">Satuan</th>
