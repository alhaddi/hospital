		...
		<?php $no = 0; foreach($query as $row) { ?>
				<tr>
					<td style="text-align:center;"><?=++$no?></td>
						...
						<td style="text-align:left;"><?=$row["urut"]?></td>
						<td style="text-align:left;"><?=$row["icon"]?></td>
						<td style="text-align:left;"><?=$row["parent_id"]?></td>
						<td style="text-align:left;"><?=$row["dashboard"]?></td>
						<td style="text-align:left;"><?=$row["warna_dashboard"]?></td>
				</tr>
		<?php } ?>
		</tbody>
	</table>
