					...
					<div class="actions">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>
									<a data-download="excel" data-download-url="menu/excel"><i class="fa fa-file-excel-o fa-fw"></i> Excel (.xlsx)</a>
								</li>
								<li>
									<a data-download="pdf" data-download-url="menu/pdf"><i class="fa fa-file-pdf-o fa-fw"></i>Pdf (.pdf)</a>
								</li>
							</ul>
						</div>
					</div>
					...
					>
						<thead>
							<tr>
								...
								<th data-datatable-align="text-left">Link</th>
								<th data-datatable-align="text-left">Urut</th>
								<th data-datatable-align="text-left">Icon</th>
								<th data-datatable-align="text-left">Parent_id</th>
								<th data-datatable-align="text-left">Dashboard</th>
								<th data-datatable-align="text-left">Warna_dashboard</th>
