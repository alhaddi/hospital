	...
	<body class='login'>
		...
		<div class="wrapper">
			<div class="login-body">
				...
				<center class="login-margin"><img src="<?=FILES_HOST?>img/logo.png" alt="" class='retina-ready' width="180px"></center>
		...
		<div id="footer_login">
			<h4>HIMS Indonesia				
				<p>
					<a href="http://hims.web.id" target="_blank" style="color:white;text-decoration:none;">http://hims.web.id</a>
				</p>
			</h4>
			<p class="right">
				<b>Twitter</b>
			...
			<p class="rightbottom">
				<b>Facebook</b>
				: 
				<a href="https://www.facebook.com/himssystem" target="_blank" style="color:white;text-decoration:none;">facebook.com</a>
			</p>
		</div>
	</body>
