					<div class="form-vertical">
						...
						<div class="form-group">
							...
							<input type="text" name="kode_golongan"  value="<?=element('kode_golongan',$row)?>" id="kode_golongan" class="form-control"  >
						</div>
						
						<div class="form-group">
							<label for="nama" class="control-label">Jenis Jabatan</label>
							<input type="text" name="jenis_jabatan"  value="<?=element('jenis_jabatan',$row)?>" id="jenis_jabatan" class="form-control"  >
						</div>						
						<div class="form-group">
