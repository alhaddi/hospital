					...
					<div class="actions">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>
									<a data-download="excel" data-download-url="jenis_bayar/excel"><i class="fa fa-file-excel-o fa-fw"></i> Excel (.xlsx)</a>
								</li>
								<li>
									<a data-download="pdf" data-download-url="jenis_bayar/pdf"><i class="fa fa-file-pdf-o fa-fw"></i>Pdf (.pdf)</a>
								</li>
							</ul>
						</div>
					</div>
					...
					>
						<thead>
							<tr>
								...
								<th data-datatable-align="text-left">No_kartu</th>
								<th data-datatable-align="text-left">Bank</th>
								<th data-datatable-align="text-left">Aktif</th>
