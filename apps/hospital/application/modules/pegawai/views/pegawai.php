					...
					<div class="actions">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li>
									<a data-download="excel" data-download-url="pegawai/excel"><i class="fa fa-file-excel-o fa-fw"></i> Excel (.xlsx)</a>
								</li>
							</ul>
						</div>
					</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" onclick="$('#addmodal').modal('hide'); swal('Selamat !!','Data berhasil disimpan.','success');" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div>
