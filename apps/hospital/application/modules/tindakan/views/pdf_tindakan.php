...
<page backtop="40mm" backbottom="0mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		<h1 style="text-align:center"><?=strtoupper("Daftar Tindakan")?></h1>
    </page_header>
    <page_footer>
		...
		<thead>
			<tr class="">
				<th style="text-align:center" style="width:20px;">No.</th>
						...
						<th style="text-align:left;">Id Kategori Tindakan</th>
		...
		<?php $no = 0; foreach($query as $row) { ?>
				<tr>
					<td style="text-align:center;"><?=++$no?></td>
						...
						<td style="text-align:left;"><?=$row["biaya"]?></td>
						<td style="text-align:left;"><?=$row["id_kategori_tindakan"]?></td>
