...
class Tindakan_model extends MY_Model {
	...
	function get_datatables()
	{
		...
		$query = $this->db->select('
			...
			ms_poliklinik.nama as namapoli
		')
		->join('ms_kategori_tindakan','ms_kategori_tindakan.id = ms_tindakan.id_kategori_tindakan','inner')
		->join('ms_poliklinik','ms_poliklinik.id = ms_tindakan.id_ms_poliklinik','inner')
		->get();
		return $query->result();
	}
