				...
				<div class="modal-body">
					<div class="form-vertical">
						...
						<div class="form-group">
							...
							<input type="text" name="nip" id="nip" class="form-control" data-rule-required="true">
						</div>
						...
						<div class="form-group">
							<label for="nama" class="control-label">Tugas</label>
							<input type="text" name="tugas" id="tugas" class="form-control" data-rule-required="true">
						</div>
