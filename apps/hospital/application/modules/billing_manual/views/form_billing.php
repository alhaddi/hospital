<form id="form_<?=$id_table?>" action="<?=site_url('billing_manual/save_pembayaran')?>" method="POST">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-vertical">
						...
						<div class="form-group">
							<label for="textfield" class="control-label">Nama Penunjang</label>
							<select name="id_ms_penunjang" onchange="load_kategori();" id="id_ms_penunjang" class="form-control" >
								<?php foreach($this->db->get("ms_penunjang")->result() as $r){ ?>
...
function load_kategori(){
	...
	$.ajax({
		url		: "<?=site_url('billing_manual/billing_penunjang')?>",
		type	: "post",
		data	:{
			PenunjangID : id_ms_penunjang,
			selected : ''
		},
		success	: function(jdata){
			$("#load_kategori").html(jdata);
		}
	});
}
