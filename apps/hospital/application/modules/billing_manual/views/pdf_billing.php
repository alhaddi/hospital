...
<page backtop="40mm" backbottom="0mm" backleft="0mm" backright="0mm">
    <page_header>
        <?=$header?>
		<h1 style="text-align:center"><?=strtoupper("Daftar Billing")?></h1>
    </page_header>
    <page_footer>
		...
		<thead>
			<tr class="">
				<th style="text-align:center" style="width:20px;">No.</th>
						...
						<th style="text-align:left;">Id Pasien</th>
						<th style="text-align:left;">Id Komponen</th>
						<th style="text-align:left;">No Tagihan</th>
		...
		<?php $no = 0; foreach($query as $row) { ?>
				<tr>
					<td style="text-align:center;"><?=++$no?></td>
						...
						<td style="text-align:left;"><?=$row["id_pasien"]?></td>
						<td style="text-align:left;"><?=$row["id_komponen"]?></td>
						<td style="text-align:left;"><?=$row["no_tagihan"]?></td>
						<td style="text-align:left;"><?=$row["nominal"]?></td>
						<td style="text-align:left;"><?=$row["total_bayar"]?></td>
						<td style="text-align:left;"><?=$row["sisa"]?></td>
				</tr>
		<?php } ?>
		</tbody>
	</table>
