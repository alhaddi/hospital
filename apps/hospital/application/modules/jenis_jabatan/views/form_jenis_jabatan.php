				...
				<div class="modal-body">
					<div class="form-vertical">
						<div class="form-group">
							<label for="nama" class="control-label">Kode Jenis Jabatan</label>
							<input type="text" name="kd" id="kd" class="form-control" data-rule-required="true" data-rule-maxlength="15">
						</div>
						<div class="form-group">
