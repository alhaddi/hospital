		...
		<thead>
			<tr class="">
				<th style="text-align:center; width:20px; border:solid 1px #000;">No.</th>
						...
						<th style="text-align:center; width:75px; border:solid 1px #000;">Cara Bayar</th>
						<th style="text-align:center; width:100px; border:solid 1px #000;">Poliklinik</th>
						<th style="text-align:center; width:75px; border:solid 1px #000;">Komponen</th>
						<th style="text-align:center; width:100px; border:solid 1px #000;">Tanggal</th>
						<th style="text-align:center; width:75px; border:solid 1px #000;">Nominal</th>
			</tr>
		</thead>
		<tbody>
